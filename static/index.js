window.app = Vue.createApp({
    ...
    methods: {
        ...
        async updateParticipantForm(tempId, raisenow) {
            const participant = _.findWhere(this.participants.data, {
                id: tempId,
            });
            this.ParticipantsFormDialog.data = {
                ...participant,
        ...
        async deleteAllParticipants(participantId) {
            let raisenow = _.findWhere(this.participants.data, {
                id: participantId,
            });
            let wallet = _.findWhere(this.g.user.wallets, {
                id: raisenow.wallet,
        ...
        async deleteParticipant(participantId) {
            ...
            let raisenow = _.findWhere(this.ranow, {
                id: participant.raisenow,
            });
            let wallet = _.findWhere(this.g.user.wallets, {
                id: raisenow.wallet,
            });
